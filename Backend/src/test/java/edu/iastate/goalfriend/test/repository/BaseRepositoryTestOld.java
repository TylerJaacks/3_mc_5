...
public abstract class BaseRepositoryTestOld {
    ...
    protected void createTestGoal1() {
        goal1.setGoalName("ExampleGoal1");
        User user = new User();
        user.setUsername("exampleUser");
        user.setEmail("email@email.com");
        user.setPhoneNumber("1234567890");
        goal1.setGoalOwner(user);
        goal1.setGoalCategory(GoalCategory.NOT_SET);
        goal1.setGoalProgress(0.5f);
    }
