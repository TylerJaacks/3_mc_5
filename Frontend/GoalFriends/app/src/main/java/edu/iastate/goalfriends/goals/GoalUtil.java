...
public final class GoalUtil {
    ...
    public static ArrayList<Goal> populateGoals(int amount) {
        ArrayList<Goal> arr = new ArrayList<>(amount);
    ...
    public static boolean isGoalEmpty(Goal goal) {
        if (goal.equals(null)) {
            ...
            return goal.getName().equals("Default") && goal.getProgress() == 0 && goal.getCategory().equals("None") && goal.getDescription().equals("None");
        }
    }
    ...
    public static boolean isGoalsEqual(Goal goal1, Goal goal2) {
        ...
        else return goal1.getName().equals(goal2.getName()) && goal1.getDescription().equals(goal2.getDescription()) && goal1.getCategory().equals(goal2.getCategory()) && goal1.getProgress() == goal2.getProgress();
    }
